  ...
  return (
    <section id="projects" className="py-20 bg-background-secondary">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        {/* Internship Projects */}
        <h3 className="text-2xl font-semibold mb-4 mt-12">Practical Training Projects</h3>
        <div className="relative group">
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto text-sm leading-relaxed">
            Contributed to <strong>10+ additional full-stack and AI-focused projects</strong> during my practical training experience,
