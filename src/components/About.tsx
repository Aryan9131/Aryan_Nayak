...
const About = () => {
  ...
  const techStack = [
    ...
    "Power Apps", "Dataverse", "Power Automate", "Copilot"
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  During my comprehensive training at <strong>Coding Ninjas</strong>, <strong className="text-foreground">I gained practical industry experience by 
                  collaborating with startup </strong> on AI-powered platforms, contributing to scalable backend systems, 
                  WebSocket notifications, and generative AI workflows. At <strong>Unified Mentor</strong>, I developed web 
                  platforms with secure payments, real-time databases, and Google Maps integration.
                </p>

                <p className="text-lg text-muted-foreground leading-relaxed">
                  With a strong foundation in <strong>Full stack Web development, databases, and scalable architecture</strong>, I focus on 
                  delivering applications that combine performance with innovation. I also have experience with 
                  <strong className="text-foreground"> Microsoft Power Platform</strong> for business process automation. Beyond coding, I stay curious, 
                  explore emerging AI technologies, and contribute to impactful projects.
                </p>
              </div>
